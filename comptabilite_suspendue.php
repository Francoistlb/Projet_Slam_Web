  ...
  {  
   ...
   // CONNEXION A LA BASE DE DONNEES
    ...
    echo'</div></div></div></div></div>
      ...
      // RECUPERATION DES DONNEES DE LA FICHE FRAIS POUR LE STATUT "SUSPENDU"
      $nvl_ff="SELECT u.Nom_utilisateur, u.Prenom_utilisateur, u.Mail_utilisateur, 
                     ...
                     WHERE f.Statut_validation=2 AND f.ID_fiche_frais=$ID_ff";
      ...
      // BOUTON DE VALIDATION DE LA FICHE FRAIS
      }
      echo"<!DOCTYPE html>
      <form action='comptabilite_suspendue.php?&ID_ut=".$ID_ut."?&ID_ff=".$ID_ff."' method='POST'>
