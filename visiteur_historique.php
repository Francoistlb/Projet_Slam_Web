 ...
 if (!isset ($_SESSION['email']) || $_SESSION['role'] !=0)
 {
  ...
  {  
   if (empty($_GET['ID_ff']))
   {
      ...
      header('Refresh: 0.1 ; visiteur_accueil.'); 
      ob_flush();
   }
// SECURITE DE CONNEXION A LA PAGE
   ...
   // CONNEXION A LA BASE DE DONNEES
    ...
    echo'</div></div></div></div></div>
      ...
      // RECUPERATION DES DONNEES DE LA FICHE FRAIS
      $nvl_ff="SELECT u.Nom_utilisateur, u.Prenom_utilisateur, u.Mail_utilisateur, 
                     ...
                     WHERE f.ID_utilisateur=$ID_ut AND f.ID_fiche_frais=$ID_ff";
      ...
      echo'<a href="visiteur_accueil.php" class="nvlff"> Retour </a><br><br>';
       // REDIRECTION VERS ACCUEIL
